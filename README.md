...
```
src/billing/invoice.py:8:25: NOPRIM001 parameter "customer" is annotated "str"
src/billing/invoice.py:8:33: NOPRIM002 return type is annotated "int"
Checked 1 file in 31ms - found 2 violations
```
...
datetime   AwareDatetime, PastDatetime, FutureDatetime, RootModel[datetime]
...
cli.py:7:31: NOPRIM001 parameter "dry_run" is annotated "bool"
Checked 1 file in 31ms - found 2 violations
```
...
```
 ...
 Usage: noprim check [OPTIONS] [paths]...                                       
